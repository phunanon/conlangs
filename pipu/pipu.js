...
//Language features: pronouns, clause dividers, conditionals
    ...
    pep: { root: "all/always", type: "quantity, time", verb: "", adj: "many", pnoun: "", comment: "", num:    7, colour: "#030" },
    pet: { root: "nothing/never", type: "quantity, time", verb: "", adj: "few", pnoun: "", comment: "", num:    8, colour: "#033" },
    pek: { root: "partial/sometimes", type: "quantity, time", verb: "", adj: "some", pnoun: "", comment: "", num:    9, colour: "#036" },
    pef: { root: "only/just", type: "quantity, time", verb: "", adj: "", pnoun: "", comment: "", num:   10, colour: "#039" },
    pew: { root: "any", type: "quantity", verb: "", adj: "", pnoun: "", comment: "", num:   11, colour: "#03c" },
    pes: { root: "every", type: "quantity", verb: "", adj: "", pnoun: "", comment: "", num:   12, colour: "#03f" },
    ...
    phw: { root: "compare_to", type: "", verb: "", adj: "must", pnoun: "", comment: "Used to denote a comparison between the leading and following clause", num:   46, colour:  null  },
    ...
    phx: { root: "question/?", type: "question", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
...
//Life, nature, time
/*
etq: { root: "", type: "", verb: "", adjective: "", pnoun: "", comment: "", numeric: 64, colour: "#33c" },
...
*/
    ...
    wis: { root: "earth/mountain", type: "", verb: "", adj: "large/big/much", pnoun: "", comment: "", num:  201, colour: "#c0f" },
    wix: { root: "", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
    wep: { root: "water/rain/river/Spring", type: "rain/drink", verb: "wet", adj: "", pnoun: "", comment: "", num:  203, colour: "#c30" },
    wet: { root: "fire/light/Summer ", type: "", verb: "burn", adj: "bright", pnoun: "", comment: "", num:  204, colour: "#c33" },
    wek: { root: "air/wind/Autumn", type: "", verb: "blow", adj: "windy", pnoun: "", comment: "", num:  205, colour: "#c36" },
    wef: { root: "snow/Winter", type: "", verb: "snow", adj: "", pnoun: "", comment: "", num:  206, colour: "#c39" },
    ...
    wap: { root: "noise", type: "", verb: "", adj: "loud", pnoun: "", comment: "", num:  210, colour: "#c60" },
    ...
    wuk: { root: "now", type: "", verb: "", adj: "little/small", pnoun: "", comment: "", num: 233, colour: "#cf6" },
    ...
    wus: { root: "", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  236, colour: "#cff" },
    wuc: { root: "", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  237, colour:  null  },
    wux: { root: "moon/night", type: "", verb: "obscure/cover/sleep", adj: "cold", pnoun: "", comment: "", num:  NaN, colour:  null  },
    whp: { root: "yesterday", type: "", verb: "", adj: "most", pnoun: "", comment: "", num:  238, colour:  null  },
    wht: { root: "today", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  239, colour:  null  },
    whk: { root: "tomorrow", type: "", verb: "", adj: "least", pnoun: "", comment: "", num:  240, colour:  null  },
    whf: { root: "", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  241, colour:  null  },
    whw: { root: "", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  242, colour:  null  },
    whs: { root: "age", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  243, colour:  null  },
...
//Humanity and its stuff
    ...
    sep: { root: "friend/unison", type: "", verb: "", adj: "friendly/in unison", pnoun: "", comment: "", num:  252, colour: "#f30" },
    set: { root: "enemy", type: "", verb: "", adj: "hostile", pnoun: "", comment: "", num:  253, colour: "#f33" },
    sek: { root: "family", type: "", verb: "know_person", adj: "familiar", pnoun: "", comment: "", num:  254, colour: "#f36" },
    sef: { root: "neighbour", type: "", verb: "know_thing", adj: "", pnoun: "", comment: "", num:  255, colour: "#f39" },
    ...
    sap: { root: "adult", type: "", verb: "", adj: "more", pnoun: "", comment: "", num:  259, colour: "#f60" },
    sat: { root: "child", type: "", verb: "", adj: "les", pnoun: "", comment: "", num:  260, colour: "#f63" },
    sak: { root: "female/girl/wife/she", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  261, colour: "#f66" },
    saf: { root: "male/boy/husband/he", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  262, colour: "#f69" },
...
*/
    xip: { root: "place", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
    xit: { root: "opposite/other_side", type: "location", verb: "", adj: "beside", pnoun: "", comment: "", num:  NaN, colour:  null  },
    xik: { root: "unknown_location", type: "", verb: "lose", adj: "lost", pnoun: "", comment: "", num:  NaN, colour:  null  },
    ...
    xep: { root: "house/home", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
    xet: { root: "village", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
    xek: { root: "town", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
    xef: { root: "city", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
    xew: { root: "country", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
    xes: { root: "wall/fence", type: "", verb: "", adj: "", pnoun: "", comment: "", num:  NaN, colour:  null  },
