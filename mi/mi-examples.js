...
let _examples = [
    ...
    ["The sun shines.", "h:nh n:sun v:shine"],
    ["The sun is shining.", "h:id n:sun v:shine"],
    ...
    ["The kitten jumped up.", "h:pd n:animal v:jump"],
    ["The kitten jumped onto the table.", "h:pd n:animal v:jump"],
    ["My little kitten walked away.", "h:pd n!my n:animal v:go_away"],
