...
//Language features: pronouns, clause dividers, conditionals, etc
    ...
    { noun: "here", type: "spatial", verb: "move_close/go_to/walk_to", adj: "close/near", comment: "" },
    { noun: "there", type: "spatial", verb: "move_away/go_from/walk_from", adj: "far_away/distant", comment: "" },
    ...
    { noun: "if_then/and_so", type: "conjunction", verb: "control", adj: "should", comment: "Used to denote an if-then relationship between the leading and following clauses" },
    { noun: "compare_to/despite", type: "", verb: "compare_to/despite", adj: "must", comment: "Used to denote a comparison between the leading and following clause" },
    { noun: "because/due_to", type: "conjunction", verb: "because/due_to", adj: "therefore", comment: "" },
...
//Communication, mathematics, direction
    ...
    { noun: "time/idea/thought/brain", type: "", verb: "think", adj: "soon/wise/smart/clever", comment: "" },
...
//Life, nature, time
    ...
    { noun: "sky/history/story", type: "", verb: "remember", adj: "high", comment: "" },
...
//Humanity and its stuff
    ...
    { noun: "neighbour", type: "", verb: "know_thing/realise", adj: "known/famous", comment: "" },
    { noun: "adult/parent", type: "", verb: "", adj: "more", comment: "" },
    { noun: "child/infant/seed", type: "", verb: "", adj: "less", comment: "" },
    { noun: "female/girl/wife/she/her/hers", type: "", verb: "", adj: "female/feminine", comment: "" },
    { noun: "male/boy/husband/he/him/his", type: "", verb: "", adj: "male/masculine", comment: "" },
//Buildings, furniture, structures, protocols, objects, locations
    ...
    { noun: "opposite/other_side/other", type: "~spacial", verb: "", adj: "beside/other", comment: "" },
    { noun: "unknown_location/unknown_position", type: "spacial", verb: "lose/around/loose", adj: "lost/around", comment: "" },
...
let _noun_multi = {
    proper: ["patrick"],
    life: ["bee", "canine", "feline"],
    food: ["sugar", "kiwi", "strawberry"],
    protocol: ["socialism"],
    measure: ["year"]
};
...
let _noun_multi = [
    ...
    { noun: "farmer", nouns: "person plant" },
