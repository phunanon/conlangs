...
let lex = [
    ...
    { k: 0x53, n: "heat", v: "take/receive", a: "hot" },
    { k: 0x54, n: "cold", v: "give", a: "cold" },
    { k: 0x55, n: "land", v: "", a: "" },
    { k: 0x56, n: "sky", v: "fly", a: "big" },
    { k: 0x57, n: "", v: "", a: "" },
    { k: 0x58, n: "mountain", v: "", a: "" },
    { k: 0x59, n: "death", v: "kill", a: "dead" },
    { k: 0x5A, n: "", v: "", a: "" },
...
let multi_lex = [
    ...
    { k: 0x00, m: "class word", n: "ling_article", a: "" },
    ...
    { k: 0x00, m: "person person", n: "crowd", a: "" },
    { k: 0x00, m: "house house", n: "village", a: "" },
    { k: 0x00, m: "mind house house", n: "fame", a: "famous" },
    ...
    { k: 0x00, m: "land sky", n: "dust", a: "" },
    { k: 0x00, m: "person movement", n: "footstep", a: "" },
    { k: 0x00, m: "movement food", n: "bite", a: "" },
    { k: 0x00, m: "mountain house", n: "city", a: "" },
    { k: 0x00, m: "book time", n: "newspaper", a: "" },
    { k: 0x00, m: "person book", n: "writer", a: "" },
    { k: 0x00, m: "person book time", n: "journalist", a: "" }
];
let n_index = {};
let v_index = {};
let a_index = {};
...
function create_multi_indexes ()
{
    for (let l = 0, l_len = multi_lex.length; l < l_len; ++l) {
        ...
        for (let m in multi) {
            if ((multi[m] = gloss2num(0, multi[m])) == -1)
